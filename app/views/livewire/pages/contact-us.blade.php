            ...
            <main class="overflow-hidden">
                    ...
                    <div class="py-24 lg:py-32">
                        <div class="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
                            ...
                            <p class="mt-6 text-xl text-warm-gray-500 max-w-3xl">
                                Get in touch with us to make enquiries, to discuss business opportunities and/or
                                partnerships. We will get back to you in a short time.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <section class="relative bg-white" aria-labelledby="contact-heading">
                    ...
                    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <svg class="text-gray-200 absolute z-0 top-0 right-0 transform -translate-y-16 translate-x-1/2 sm:translate-x-1/4 md:-translate-y-24 lg:-translate-y-72" width="404" height="384" fill="none" viewBox="0 0 404 384" aria-hidden="true">
                            <defs>
                                ...
                                <div class="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-teal-500 to-teal-600 sm:px-10 xl:p-12">
                                    ...
                                    <dl class="mt-8 space-y-6">
                                        ...
                                        <dd class="flex text-base text-teal-50">
                                            ...
                                            <span class="ml-3">ask@fureaenergy.com</span>
                                        </dd>
                                    </dl>
                                    <ul role="list" class="mt-8 flex space-x-12">
                                        <li>
                                            <a class="text-teal-200 hover:text-teal-100" href="https://twitter.com/@FureaEnergy">
                ...
                <section aria-labelledby="offices-heading">
                    <div class="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                        <h2 id="offices-heading" class="text-3xl font-extrabold text-warm-gray-900">Our office</h2>
                        <p class="mt-6 text-lg text-warm-gray-500 max-w-3xl">
                            Our physical office is open for enquiries and other business opportunity discussions.
                        </p>
                        <div class="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
                            <div>
                                <h3 class="text-lg font-medium text-warm-gray-900">Lagos, Nigeria</h3>
                                <p class="mt-2 text-base text-warm-gray-500">
                                    <span class="block">4556 Brendan Ferry</span>

                                    <span class="block">Lekki, Lagos</span>
                                </p>
                            </div>
                        </div>
                    </div>
